...
df_uur_verw["uur"] = pd.to_numeric(df_uur_verw["uur"], errors="coerce")  # Zorgt dat alles numeriek is
df_uur_verw = df_uur_verw.dropna(subset=["uur"])  # Verwijdert rijen zonder uurwaarde
df_uur_verw["uur"] = df_uur_verw["uur"].astype(int)  # Zet om naar integer
